...
public class RegistrationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//se non è possibile dalla sim...setta solo il prefisso nazioanle
		else {
	...
	private boolean registerRoutine(URL serverBaseUrl, String phoneNumber) {
		...
		while (deviceId == null) {
			...
			//i dati vanno nelle shared preferences
		...
		try {
			...
			Log.e("socialstudy", "Errore in fase di registrazione con il server", e);
			return false;
		}
